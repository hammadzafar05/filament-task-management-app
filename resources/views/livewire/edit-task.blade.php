                            ...
                            <div class="flex flex-col w-full">
                                <form wire:submit.prevent="update" class="w-full">
                                    <div class="mb-4">
                                        ...
                                        <x-text-input wire:model.defer="task.title" id="title"
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea wire:model.defer="task.description" id="description"
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select wire:model="task.status_id" id="status" class="block mt-1 w-full"
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select wire:model="task.tags" id="tags" class="block mt-1 w-full"
                                            name="tags" multiple>
                                        ...
                                        <x-input-error :messages="$errors->get('task.tags')" class="mt-2" />
                                    </div>
